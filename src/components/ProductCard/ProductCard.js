...
export default function ProductCard({ card }) {
  ...
  const id = user ? user.carrinho.id : 20;
  let size = 38;
  ...
  return (
    <div className="productCard">
      {card.map((eachCard) => (
        <form
          onSubmit={(e) => HandleSubmitCart(e, eachCard.id)}
          className="productCard-form"
        >
          <div className="productCard-div" key={eachCard.id} /*ref={keyRef}*/>
            ...
            <div className="productCard-div-button">
              <p className="productCard-div-button-price">
                {eachCard.preco.toFixed(2)}
              </p>
