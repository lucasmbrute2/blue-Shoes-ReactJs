          ...
          {productUnique.map((eachProduct) => (
            <div className="CardProduct-div-details-div" key={eachProduct.id}>
              ...
              <div className="items-description">
                ...
                <p>
                  <span className="items-description-span">Cor:</span> Azul
                </p>
                <p>
                  <span className="items-description-span">Tamanho: </span>39
                </p>
              </div>
              ...
              <p className="price-number">
                {valor ? valor.toFixed(2) : (99.9).toFixed(2)}
              </p>
            </div>
          ))}
        </div>
