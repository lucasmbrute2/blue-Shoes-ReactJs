            ...
            <div className="cardProduct-div">
              <div className="cardProduct-div-details">
                ...
                {productUnique.map((eachProduct) => (
                  <div
                    className="CardProduct-div-details-div"
                    key={eachProduct.id}
                  >
                    <img className="img-CardProduct" src={eachProduct.imagem} />
                    <div className="items-description">
                      <h3 className="items-description-h3">
                        {eachProduct.nome}
                      </h3>
                      <p>
                        <span className="items-description-span">Cor:</span>{" "}
                        Azul
                      </p>
                      <p>
        ...
        <div className="Container-checkout">
          ...
          <div className="Container-pagamento">
            ...
            <p>
              ...
              data de vencimento é de 2 dias corridos após a conclusão do
